Return-Path: <target-devel+bounces-748-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 2Bc0Dq0HsGlregIAu9opvQ
	(envelope-from <target-devel+bounces-748-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 12:59:41 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 8BE9624BF6E
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 12:59:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id D46913194E42
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 11:56:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 577F5423162;
...
X-Spamd-Result: default: False [1.54 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-748-lists,target-devel=lfdr.de];
	MISSING_XM_UA(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[avm.de:mid,avm.de:email,suse.com:email,sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo]
