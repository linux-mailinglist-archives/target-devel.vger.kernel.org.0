...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 435586A05F
	for <lists+target-devel@lfdr.de>; Tue, 16 Jul 2019 03:39:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729803AbfGPBjw (ORCPT <rfc822;lists+target-devel@lfdr.de>);
        Mon, 15 Jul 2019 21:39:52 -0400
Received: from mx.hosthub.ro ([89.33.233.5]:57496 "EHLO mx.hosthub.ro"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729674AbfGPBjv (ORCPT <rfc822;target-devel@vger.kernel.org>);
        Mon, 15 Jul 2019 21:39:51 -0400
Received: from [192.168.0.55] (unknown [83.166.214.14])
        (Authenticated sender: avladulescu@bfproject.ro)
        by mx.hosthub.ro (Postfix) with ESMTPSA id 05015286F633;
        Tue, 16 Jul 2019 04:39:48 +0300 (EEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=bfproject.ro;
        ...
        bh=oc2DNrXw1zLXSQybpix0p/ZgO1oI1ZgKZlawDiJKel8=;
        b=ZEsanEGK+x8b27KxXGkLH3LCgckX5G83KFwWU3aWWM5BMquuWcD0r7XgUvgmAaq4WHDcVS
        6AXwRtbioUnZC4ad+R/HiazjMZ1GFpvy5/YV1bqL5N7M5r/A1CBOryDiFiGGaHJKoEHs3h
        VZhywyTaClqX5XqlHGL9s9KGffvk2aM=
From:   Alex Vladulescu <avladulescu@bfproject.ro>
Subject: LIO fails to run on nvme drives
To:     target-devel@vger.kernel.org
Message-ID: <e562bc80-aae1-f311-14ce-19c49b55e1a5@bfproject.ro>
Date:   Tue, 16 Jul 2019 04:39:45 +0300
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=bfproject.ro;
        ...
        h=from:sender:reply-to:subject:date:message-id:to:cc:mime-version:content-type:content-transfer-encoding:resent-to:resent-cc:resent-from:resent-sender:resent-message-id:in-reply-to:references:list-id:list-owner:list-unsubscribe:list-subscribe:list-post;
        bh=oc2DNrXw1zLXSQybpix0p/ZgO1oI1ZgKZlawDiJKel8=;
        b=PAYBLtCGsVYnIjX/zpA65ncem3q/ItGp8ohS2tI+6AIazuJW31dJxQrzczGZ3FQzCxIl71
        5wjxPoUD4XollrTlhC8hTZGEF0yhQdHkWwDIKXEL8FlwwrQM8oDTSsvRYxyksGQjcRZJX8
        /MpFIjpZ5cbwtGvAJ4v7I8HJlFuN4l0=
ARC-Seal: i=1; s=mx; d=bfproject.ro; t=1563241188; a=rsa-sha256; cv=none;
        b=tb9EY8pPmSNkVaZ+qgEnWBpAgnSzn6UrRBLPB4wX0iRE0u9XaZRpX4PuI+pq3RoeoKIvmopJE5y6o7aKpzNJ5+jwN7rda5uD5T8JMC/RLTFAgRoyvIUVLcwXSClVanAqSOXKOO/DeRhuT4xICYY0XvJC0L6mo/CExd/OJpCv8oQ=
...
///Jul 16 03:07:34 iscsi01 target[12486]:  * Unloaded ib_srpt fabric module/
