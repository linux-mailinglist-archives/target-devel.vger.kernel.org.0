Return-Path: <target-devel+bounces-861-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id YE8gOu70sWl7HQAAu9opvQ
	(envelope-from <target-devel+bounces-861-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Thu, 12 Mar 2026 00:04:14 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id A0AD326B16C
	for <lists+target-devel@lfdr.de>; Thu, 12 Mar 2026 00:04:14 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 57B363042465
	for <lists+target-devel@lfdr.de>; Wed, 11 Mar 2026 23:03:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 094693A16BA;
...
X-Spamd-Result: default: False [3.14 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-861-lists,target-devel=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[kieran.bingham@ideasonboard.com,target-devel@vger.kernel.org];
