Return-Path: <target-devel+bounces-856-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id UI+hM+E6sWlYswIAu9opvQ
	(envelope-from <target-devel+bounces-856-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Wed, 11 Mar 2026 10:50:25 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 95AA6261391
	for <lists+target-devel@lfdr.de>; Wed, 11 Mar 2026 10:50:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id B5F57308625E
	for <lists+target-devel@lfdr.de>; Wed, 11 Mar 2026 09:44:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C44783B9D92;
...
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9E86E3B775B
	for <target-devel@vger.kernel.org>; Wed, 11 Mar 2026 09:32:25 +0000 (UTC)
...
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 75917C2BCB1
	for <target-devel@vger.kernel.org>; Wed, 11 Mar 2026 09:32:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	...
	b=JfVWEI4zDrh3iHX+1r4cle8Phcf0RBN0zERjJ8PQNA3EYWSATJ9h5lha/xBvVFGnI
	 ...
	 x5H4ornHcPhQg==
Received: by mail-yx1-f54.google.com with SMTP id 956f58d0204a3-64ae222d87dso12762971d50.2
        for <target-devel@vger.kernel.org>; Wed, 11 Mar 2026 02:32:25 -0700 (PDT)
X-Forwarded-Encrypted: i=1; AJvYcCVIukCg0BKsgebHPClTjb2upI3pu2sPGUvSy/vzzMKraMGUm2BRdXWz5Lf9ZDm7c7jTmfvhpw3d7I5nih8=@vger.kernel.org
X-Gm-Message-State: AOJu0YxxO1rZV+FA5Zk8R4vCiG7GFnLz3QIybsstvSwpiOqcYr7kl5vo
	3LYGfskKUlr08E4vmAU9AYjvKEVLC2rfRzWzW28SBlPRPo5fzo4Mot1Bq3X9WcwDSsQpmmfuOHk
	VgC6sndf+hT8SJZyorFM6sMF6dtVvTwE=
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-856-lists,target-devel=lfdr.de];
	MISSING_XM_UA(0.00)[];
	FROM_HAS_DN(0.00)[];
	TO_DN_SOME(0.00)[];
	RCVD_COUNT_FIVE(0.00)[5];
	PRECEDENCE_BULK(0.00)[];
	FROM_NEQ_ENVFROM(0.00)[linusw@kernel.org,target-devel@vger.kernel.org];
