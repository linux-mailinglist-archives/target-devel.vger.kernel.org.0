Return-Path: <target-devel+bounces-808-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mIckJRgUsGl1fQIAu9opvQ
	(envelope-from <target-devel+bounces-808-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 13:52:40 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 0499F24F0E0
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 13:52:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id EC6F8336BFC3
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 12:35:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 54FCF3F99F2;
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-808-lists,target-devel=lfdr.de];
	MISSING_XM_UA(0.00)[];
	FROM_HAS_DN(0.00)[];
	TO_DN_SOME(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[coraid.com:email,sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo,avm.de:dkim,avm.de:email,avm.de:mid,kernel.dk:email]
