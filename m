Return-Path: <target-devel+bounces-1209-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id pg0MCNUCKWo6OwMAu9opvQ
	(envelope-from <target-devel+bounces-1209-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Wed, 10 Jun 2026 08:23:17 +0200
X-Original-To: lists+target-devel@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 7C83D666321
	for <lists+target-devel@lfdr.de>; Wed, 10 Jun 2026 08:23:16 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	...
	dkim=pass header.d=suse.de header.s=susede2_rsa header.b="waHJe4W/";
	dkim=pass header.d=suse.de header.s=susede2_ed25519 header.b=U6EAtjYv;
	spf=pass (mail.lfdr.de: domain of "target-devel+bounces-1209-lists+target-devel=lfdr.de@vger.kernel.org" designates 172.105.105.114 as permitted sender) smtp.mailfrom="target-devel+bounces-1209-lists+target-devel=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=suse.de;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id F1144304A7AA
	for <lists+target-devel@lfdr.de>; Wed, 10 Jun 2026 06:21:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8736D372B24;
	Wed, 10 Jun 2026 06:21:14 +0000 (UTC)
X-Original-To: target-devel@vger.kernel.org
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.223.130])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id ED75E33F58B
	for <target-devel@vger.kernel.org>; Wed, 10 Jun 2026 06:21:12 +0000 (UTC)
...
X-Spamd-Result: default: False [-2.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-1209-lists,target-devel=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
 ...
 el-feedback-list@broadcom.com,m:jgross@suse.com,m:sstabellini@kernel.org,m:oleksandr_tyshchenko@epam.com,m:xen-devel@lists.xenproject.org,m:john.g.garry@oracle.com,s:lists@lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[oracle.com:email,broadcom.com:email,vger.kernel.org:from_smtp,tor.lore.kernel.org:rdns,tor.lore.kernel.org:helo,suse.de:dkim,suse.de:email,suse.de:mid,suse.de:from_mime]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: 7C83D666321
