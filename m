Return-Path: <target-devel+bounces-959-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id QEYTG1s/vGn6vgIAu9opvQ
	(envelope-from <target-devel+bounces-959-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Thu, 19 Mar 2026 19:24:27 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 2C36F2D0CDD
	for <lists+target-devel@lfdr.de>; Thu, 19 Mar 2026 19:24:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id C0DEC301CDB1
	for <lists+target-devel@lfdr.de>; Thu, 19 Mar 2026 18:24:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 338DE3F7E76;
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-959-lists,target-devel=lfdr.de];
	MIME_TRACE(0.00)[0:+];
