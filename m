Return-Path: <target-devel+bounces-1262-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id fSsuF8ZQR2omWAAAu9opvQ
	(envelope-from <target-devel+bounces-1262-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Fri, 03 Jul 2026 08:03:50 +0200
X-Original-To: lists+target-devel@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id A67476FEED4
	for <lists+target-devel@lfdr.de>; Fri, 03 Jul 2026 08:03:49 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=linux.microsoft.com header.s=default header.b=HMCULshk;
	dmarc=pass (policy=none) header.from=linux.microsoft.com;
	spf=pass (mail.lfdr.de: domain of "target-devel+bounces-1262-lists+target-devel=lfdr.de@vger.kernel.org" designates 2600:3c0a:e001:db::12fc:5321 as permitted sender) smtp.mailfrom="target-devel+bounces-1262-lists+target-devel=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id C765F301F5F0
	for <lists+target-devel@lfdr.de>; Fri,  3 Jul 2026 06:03:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DB95035B63B;
...
X-Spamd-Result: default: False [-3.66 / 15.00];
 ...
 x.microsoft.com,m:jgg@nvidia.com,s:lists@lfdr.de];
	...
	FROM_HAS_DN(0.00)[];
	TAGGED_FROM(0.00)[bounces-1262-lists,target-devel=lfdr.de];
	ALIAS_RESOLVED(0.00)[];
