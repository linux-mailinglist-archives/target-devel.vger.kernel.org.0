...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 81CDB6E4F16
	for <lists+target-devel@lfdr.de>; Mon, 17 Apr 2023 19:20:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229875AbjDQRU1 (ORCPT <rfc822;lists+target-devel@lfdr.de>);
        Mon, 17 Apr 2023 13:20:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49118 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229643AbjDQRU0 (ORCPT
        <rfc822;target-devel@vger.kernel.org>);
        Mon, 17 Apr 2023 13:20:26 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 02863BBB3
        for <target-devel@vger.kernel.org>; Mon, 17 Apr 2023 10:19:26 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        ...
        bh=XSdrKeXepGuPHA2C2VcdgTo4oFL7U5RG6xFsRQUvQmQ=;
        b=aOrYFB0LUdsqnG+n/+IBJfCfTVYhUnDJI1V7sp8G/LJk69ANTa14HwvbvfeMBSZOXA/TKn
        1TrFCvn2piLi/shCdkcg8e58VfILaI6yCZzCPBDNq8/MYakm/u9DYVsxR+av395iX2h/cT
        0SwmW8momaCloH3GFlNJ5ABeqxDzuR0=
Received: from mimecast-mx02.redhat.com (mimecast-mx02.redhat.com
 [66.187.233.88]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 us-mta-655-nJqH2mSiPb-uUMH6k8THXQ-1; Mon, 17 Apr 2023 13:18:06 -0400
X-MC-Unique: nJqH2mSiPb-uUMH6k8THXQ-1
Received: from smtp.corp.redhat.com (int-mx01.intmail.prod.int.rdu2.redhat.com [10.11.54.1])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx02.redhat.com (Postfix) with ESMTPS id 1E951899711;
        Mon, 17 Apr 2023 17:18:06 +0000 (UTC)
Received: from kalibr.redhat.com (unknown [10.35.206.135])
        by smtp.corp.redhat.com (Postfix) with ESMTP id DEB6D40CE2D4;
        Mon, 17 Apr 2023 17:18:04 +0000 (UTC)
From:   Maurizio Lombardi <mlombard@redhat.com>
To:     martin.petersen@oracle.com
Cc:     michael.christie@oracle.com, target-devel@vger.kernel.org
Subject: [PATCH V2 1/3] target: iscsi: fix hang in the iSCSI login code
Date:   Mon, 17 Apr 2023 19:17:59 +0200
Message-Id: <20230417171801.208122-2-mlombard@redhat.com>
...
---
 ...
 drivers/target/iscsi/iscsi_target_nego.c  | 68 ++++++++++++-----------
...
index baf4da7bb3b4..d3bd005cdc65 100644
...
index 27e448c2d066..3e49573289bb 100644
...
+	timer_setup(&conn->login_timer, iscsit_login_timeout, 0);
 	...
 	if (iscsit_conn_set_transport(conn, np->np_transport) < 0)
 		goto free_conn;
@@ -1297,7 +1247,7 @@ static int __iscsi_target_login_thread(struct iscsi_np *np)
 		goto new_sess_out;
 	}
...
@@ -1410,8 +1360,6 @@ static int __iscsi_target_login_thread(struct iscsi_np *np)
 	if (ret < 0)
 		goto new_sess_out;
...
@@ -1427,7 +1375,7 @@ static int __iscsi_target_login_thread(struct iscsi_np *np)
 new_sess_out:
 	new_sess = true;
 old_sess_out:
-	iscsi_stop_login_thread_timer(np);
+	iscsit_stop_login_timer(conn);
 	...
 	new_sess = false;
@@ -1441,7 +1389,6 @@ static int __iscsi_target_login_thread(struct iscsi_np *np)
 	return 1;
...
index 24040c118e49..4164977c170e 100644
...
index 94d06ddfd80a..082aaad8ef1b 100644
