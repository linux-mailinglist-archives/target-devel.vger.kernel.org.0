Return-Path: <target-devel+bounces-812-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 0JDaBQ0bsGlAfwIAu9opvQ
	(envelope-from <target-devel+bounces-812-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 14:22:21 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id EB9992500AF
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 14:22:20 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id A35B5319C890
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 13:01:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 965863BC694;
...
X-Spamd-Result: default: False [-2.76 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-812-lists,target-devel=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[broonie@kernel.org,target-devel@vger.kernel.org];
