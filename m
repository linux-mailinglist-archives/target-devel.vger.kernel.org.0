Return-Path: <target-devel+bounces-829-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sHABGilgsGloigIAu9opvQ
	(envelope-from <target-devel+bounces-829-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 19:17:13 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D61B2564ED
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 19:17:13 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 04A8031BCD8B
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 18:13:50 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1C4313DB624;
...
X-Spamd-Result: default: False [0.94 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TO_DN_SOME(0.00)[];
	TAGGED_FROM(0.00)[bounces-829-lists,target-devel=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	RCVD_TLS_LAST(0.00)[];
	...
	FROM_NEQ_ENVFROM(0.00)[Slava.Dubeyko@ibm.com,target-devel@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
