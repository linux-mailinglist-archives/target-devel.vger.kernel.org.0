Return-Path: <target-devel+bounces-991-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id aLNlLkjNvWmsCAMAu9opvQ
	(envelope-from <target-devel+bounces-991-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Fri, 20 Mar 2026 23:42:16 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C7C42E1F01
	for <lists+target-devel@lfdr.de>; Fri, 20 Mar 2026 23:42:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id DC7C730BC33A
	for <lists+target-devel@lfdr.de>; Fri, 20 Mar 2026 22:40:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1FD8537B008;
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-991-lists,target-devel=lfdr.de];
	MIME_TRACE(0.00)[0:+];
