Return-Path: <target-devel+bounces-873-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id CIGnEOwis2mASgAAu9opvQ
	(envelope-from <target-devel+bounces-873-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Thu, 12 Mar 2026 21:32:44 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id DE51C2793F8
	for <lists+target-devel@lfdr.de>; Thu, 12 Mar 2026 21:32:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id D3354326348F
	for <lists+target-devel@lfdr.de>; Thu, 12 Mar 2026 20:28:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 865EE3B0ACF;
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-873-lists,target-devel=lfdr.de];
	MIME_TRACE(0.00)[0:+];
