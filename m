Return-Path: <target-devel+bounces-1072-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SEPYANJ73GlFRwkAu9opvQ
	(envelope-from <target-devel+bounces-1072-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Mon, 13 Apr 2026 07:14:58 +0200
X-Original-To: lists+target-devel@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 8EF323E76D7
	for <lists+target-devel@lfdr.de>; Mon, 13 Apr 2026 07:14:57 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 7A51D30087AE
	for <lists+target-devel@lfdr.de>; Mon, 13 Apr 2026 05:14:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9B385382361;
...
X-Spamd-Result: default: False [3.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-1072-lists,target-devel=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[shinichiro.kawasaki@wdc.com,target-devel@vger.kernel.org];
