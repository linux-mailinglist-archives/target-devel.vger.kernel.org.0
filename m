Return-Path: <target-devel+bounces-822-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mNBXF18usGlHgwIAu9opvQ
	(envelope-from <target-devel+bounces-822-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 15:44:47 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id C1C03252556
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 15:44:46 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 41D9A3210445
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 14:08:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E1E30391E50;
...
X-Spamd-Result: default: False [0.14 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-822-lists,target-devel=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[rostedt@goodmis.org,target-devel@vger.kernel.org];
	RCVD_VIA_SMTP_AUTH(0.00)[];
	RCPT_COUNT_GT_50(0.00)[56];
	R_DKIM_NA(0.00)[];
	NEURAL_HAM(-0.00)[-0.779];
	TAGGED_RCPT(0.00)[target-devel];
	DBL_BLOCKED_OPENRESOLVER(0.00)[efficios.com:email,goodmis.org:email,avm.de:email,gandalf.local.home:mid,sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo]
