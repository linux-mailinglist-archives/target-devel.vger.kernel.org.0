Return-Path: <target-devel+bounces-824-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id WE7cDu0wsGkShAIAu9opvQ
	(envelope-from <target-devel+bounces-824-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 15:55:41 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id BD0F4252A4A
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 15:55:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id CF546332CFD0
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 14:25:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CB6282D9484;
	Tue, 10 Mar 2026 14:25:19 +0000 (UTC)
...
Received: from outgoing.mit.edu (outgoing-auth-1.mit.edu [18.9.28.11])
	...
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3F4172DC76B
	for <target-devel@vger.kernel.org>; Tue, 10 Mar 2026 14:25:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=18.9.28.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1773152719; cv=none; b=V0xNyYxBp7ph80UeQKcb4ddgWZLqa2eHaw/4HkwJ+ejeVnYbAj8eFVBc5kTaFBkpiukS1uM6trKGkg7gid0nXSNinE+dgFS1xdDqXPrnC3Ylkxn/QVB7e+rfYPHoVdFgFZEuPgZ6hxFqQbxdcted5msnnE3lrSlHC2nEHEhAZsQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1773152719; c=relaxed/simple;
	bh=XwidptKIhvR+UF4aaOLrgKMULsgr14IRJkHhby+ViXQ=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=E8c7r1eEdB7hw6TabzrNLYHQCKlcvGnC2q80rLpF4L46+AnCUTpf7yohxy4PE6duejc+TbNC4MyR1ArYp0xiAXHfx+TaNvvHEDcBhPGsHJFLO8pi3XlTmdmxUoWLwPWLvvjqnUHWH4rul95BrPWgCtbf0ek1cWlFK+IoqmUBl9U=
...
X-Spamd-Result: default: False [-0.66 / 15.00];
 ...
 h,ursulin.net,amd.com,rock-chips.com,sntech.de,marvell.com,lunn.ch,broadcom.com,chelsio.com,plvision.eu,foss.st.com,os.amperecomputing.com,bootlin.com,linux.ibm.com,ti.com,shazbot.org,animalcreek.com,nod.at,linuxfoundation.org,8bytes.org,coraid.com,kernel.dk,baylibre.com,pengutronix.de,alien8.de,zytor.com];
	FROM_HAS_DN(0.00)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-824-lists,target-devel=lfdr.de];
	MIME_TRACE(0.00)[0:+];
	...
	TAGGED_RCPT(0.00)[target-devel,netdev];
