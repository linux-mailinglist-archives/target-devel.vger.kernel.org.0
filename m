Return-Path: <target-devel+bounces-972-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id AIkZOjFBvGm7vwIAu9opvQ
	(envelope-from <target-devel+bounces-972-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Thu, 19 Mar 2026 19:32:17 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [104.64.211.4])
	by mail.lfdr.de (Postfix) with ESMTPS id EB0C62D10A5
	for <lists+target-devel@lfdr.de>; Thu, 19 Mar 2026 19:32:16 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id F422A3068C4A
	for <lists+target-devel@lfdr.de>; Thu, 19 Mar 2026 18:26:53 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 91CF43FCB12;
...
X-Spamd-Result: default: False [0.84 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-972-lists,target-devel=lfdr.de];
	MIME_TRACE(0.00)[0:+];
