Return-Path: <target-devel+bounces-816-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sAQUBYwmsGnYgQIAu9opvQ
	(envelope-from <target-devel+bounces-816-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 15:11:24 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id C49672517FE
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 15:11:23 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 42DCB3749375
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 13:31:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 044DB3B47E0;
...
X-Spamd-Result: default: False [1.34 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-816-lists,target-devel=lfdr.de];
	...
	FROM_NEQ_ENVFROM(0.00)[chuck.lever@oracle.com,target-devel@vger.kernel.org];
	FROM_HAS_DN(0.00)[];
