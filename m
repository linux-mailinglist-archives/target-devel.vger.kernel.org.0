Return-Path: <target-devel+bounces-825-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 5r6WH0Q6sGmDhQIAu9opvQ
	(envelope-from <target-devel+bounces-825-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 16:35:32 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 33F8F253AB9
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 16:35:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 3B83C31F3FC7
	for <lists+target-devel@lfdr.de>; Tue, 10 Mar 2026 14:45:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2917A2FF147;
...
X-Spamd-Result: default: False [0.44 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-825-lists,target-devel=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	MISSING_XM_UA(0.00)[];
	FROM_HAS_DN(0.00)[];
	...
	FROM_NEQ_ENVFROM(0.00)[atomlin@atomlin.com,target-devel@vger.kernel.org];
