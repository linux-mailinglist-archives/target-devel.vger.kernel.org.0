Return-Path: <target-devel+bounces-1208-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id ZeqkFF4CKWobOwMAu9opvQ
	(envelope-from <target-devel+bounces-1208-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Wed, 10 Jun 2026 08:21:18 +0200
X-Original-To: lists+target-devel@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 327A26662EC
	for <lists+target-devel@lfdr.de>; Wed, 10 Jun 2026 08:21:18 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=none;
	dmarc=fail reason="SPF not aligned (relaxed), No valid DKIM" header.from=suse.de (policy=none);
	spf=pass (mail.lfdr.de: domain of "target-devel+bounces-1208-lists+target-devel=lfdr.de@vger.kernel.org" designates 172.232.135.74 as permitted sender) smtp.mailfrom="target-devel+bounces-1208-lists+target-devel=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 2D61B3081E2E
	for <lists+target-devel@lfdr.de>; Wed, 10 Jun 2026 06:18:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B99BB370AD3;
	Wed, 10 Jun 2026 06:18:44 +0000 (UTC)
X-Original-To: target-devel@vger.kernel.org
Received: from smtp-out2.suse.de (smtp-out2.suse.de [195.135.223.131])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5602C345745
	for <target-devel@vger.kernel.org>; Wed, 10 Jun 2026 06:18:43 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1781072324; cv=none; b=qQi79l2e8Nlrg7m8MvH/dRn2b7ST6nAMI2qIuQDjO0aTxPCkfQ4f12P1UNHK/WwHWJnrOP+cgcbxRh01BRFESoNYuXj1E/yYY+kS3Mes6DKFlrpCfBqJP8xllK8qMW4OXAiFdSCDVa4HVYZLWK7EEnTzAhaxFcLNiwnlZNJHzxc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1781072324; c=relaxed/simple;
	bh=1/856M6PqZ/8zjVZbqXQWpXYXTBEd3pLgjIjMgZCn4Q=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=Txsy9dR4zl9nQE9AJOouI+I8jp63RKaUWijD+zvPx9gFwuy6br9joK2PMtoV+TNHiisYUkJku5RKyQI9ZtzCsdMSuszASCfg/QCdZrEKQFEMck5FVNx3705V6c3Sxjg1Ji4mrmJWHDbXcX5nV2nFgVptgyvMuxreqHqoqnS0GHU=
...
X-Spamd-Result: default: False [-1.36 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-1208-lists,target-devel=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
	FORGED_SENDER(0.00)[hare@suse.de,target-devel@vger.kernel.org];
	MIME_TRACE(0.00)[0:+];
