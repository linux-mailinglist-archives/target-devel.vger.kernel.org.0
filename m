Return-Path: <target-devel+bounces-902-lists+target-devel=lfdr.de@vger.kernel.org>
Delivered-To: lists+target-devel@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id KG7YDl4HuGkWYQEAu9opvQ
	(envelope-from <target-devel+bounces-902-lists+target-devel=lfdr.de@vger.kernel.org>)
	for <lists+target-devel@lfdr.de>; Mon, 16 Mar 2026 14:36:30 +0100
X-Original-To: lists+target-devel@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id B326429A8C1
	for <lists+target-devel@lfdr.de>; Mon, 16 Mar 2026 14:36:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id BBFEF3065F2A
	for <lists+target-devel@lfdr.de>; Mon, 16 Mar 2026 13:30:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ED693398911;
...
X-Spamd-Result: default: False [0.14 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-902-lists,target-devel=lfdr.de];
	RCVD_VIA_SMTP_AUTH(0.00)[];
	FROM_HAS_DN(0.00)[];
	TAGGED_RCPT(0.00)[target-devel];
	RCVD_COUNT_FIVE(0.00)[5];
	PRECEDENCE_BULK(0.00)[];
	FROM_NEQ_ENVFROM(0.00)[robin.murphy@arm.com,target-devel@vger.kernel.org];
	TO_DN_SOME(0.00)[];
	RCPT_COUNT_GT_50(0.00)[56];
	R_DKIM_NA(0.00)[];
	NEURAL_HAM(-0.00)[-0.781];
	MID_RHS_MATCH_FROM(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[avm.de:email,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,8bytes.org:email,linux.dev:email,arm.com:email,arm.com:mid]
X-Rspamd-Queue-Id: B326429A8C1
